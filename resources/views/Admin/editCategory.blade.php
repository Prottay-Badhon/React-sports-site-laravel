...
@section('content')
  <div class="container">
                    <form class="p-5" action="{{URL::to('/updateCategory'.$category->id)}}" method="post">
                        @csrf
                        ...
                        <input type="text" value="{{$category->description}}" class="form-control" name="description" placeholder="Enter description"></input>
                        </div>
